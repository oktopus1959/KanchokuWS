...
// このファイルは ./make_hotkey_id_def.sh により ./HotKeys.cs から自動的に作成されました (2021/07/22 14:57:00)
...
namespace hotkey_id_defs {
    ...
    std::map<int, const wchar_t*> hotkeyId_name_map = {
        ...
        {(ACTIVEIME_HOTKEY + 1), _T("STROKE_HELP_ROTATION_HOTKEY")},
        {(STROKE_HELP_ROTATION_HOTKEY + 1), _T("STROKE_HELP_UNROTATION_HOTKEY")},
        {(STROKE_HELP_UNROTATION_HOTKEY + 1), _T("DATE_STRING_HOTKEY1")},
        ...
        {(CTRL_SHIFT_COLON_HOTKEY + 1), _T("FULL_ESCAPE_HOTKEY")},
        ...
        {(PREV_CAND_TRIGGER_HOTKEY + 1), _T("SPECIAL_HOTKEY_ID_END")},
    };
