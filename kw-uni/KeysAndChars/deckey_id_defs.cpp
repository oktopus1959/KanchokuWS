...
// このファイルは tools/make_deckey_id_def.sh により KanchokuWS/Domain/DecoderKeys.cs から自動的に作成されました (2022/11/18 22:58:48)
...
namespace deckey_id_defs {
    ...
    std::map<int, const wchar_t*> deckeyId_name_map = {
        ...
        {(CTRL_RIGHT_ARROW_DECKEY + 1), _T("CTRL_PAUSE")},
        {(CTRL_PAUSE_DECKEY + 1), _T("CTRL_SCR_LOCK")},
