...
namespace deckey_id_defs {
    ...
    std::map<int, const wchar_t*> deckeyId_name_map = {
        ...
        {(IME_OFF_DECKEY + 1), _T("RIGHT_CONTROL")},
        {(RIGHT_CONTROL_DECKEY + 1), _T("RIGHT_SHIFT")},
        ...
        {(EXCHANGE_CODE_TABLE_DECKEY + 1), _T("SELECT_CODE_TABLE1")},
        {(SELECT_CODE_TABLE1_DECKEY + 1), _T("SELECT_CODE_TABLE2")},
        {(SELECT_CODE_TABLE2_DECKEY + 1), _T("LEFT_SHIFT_BLOCKER")},
