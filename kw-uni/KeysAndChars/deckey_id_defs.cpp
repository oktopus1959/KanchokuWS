...
// このファイルは tools/make_deckey_id_def.sh により KanchokuWS/Domain/DecoderKeys.cs から自動的に作成されました (2022/09/26 16:05:29)
...
namespace deckey_id_defs {
    ...
    std::map<int, const wchar_t*> deckeyId_name_map = {
        ...
        {(IME_OFF_DECKEY + 1), _T("RIGHT_SHIFT")},
        ...
        {(TOGGLE_KATAKANA_CONVERSION_DECKEY + 1), _T("TOGGLE_UPPER_ROMAN_STROKE_GUIDE")},
