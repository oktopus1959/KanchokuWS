...
// このファイルは tools/make_deckey_id_def.sh により KanchokuWS/Domain/DecoderKeys.cs から自動的に作成されました (2022/11/06 08:30:53)
...
namespace deckey_id_defs {
    ...
    std::map<int, const wchar_t*> deckeyId_name_map = {
        ...
        {(EISU_MODE_TOGGLE_DECKEY + 1), _T("EISU_DECAPITALIZE")},
    };
