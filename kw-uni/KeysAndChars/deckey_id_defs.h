...
// このファイルは tools/make_deckey_id_def.sh により KanchokuWS/DecoderKeys.cs から自動的に作成されました (2022/05/09 11:06:57)
#pragma once
...
// 同時打鍵用修飾DECKEYの始まり
#define COMBO_DECKEY_START (SHIFT_B_DECKEY_END)

// 同時打鍵用修飾DECKEYの終わり(の次)
#define COMBO_DECKEY_END (COMBO_DECKEY_START + SHIFT_DECKEY_NUM)
