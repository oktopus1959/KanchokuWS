...
// このファイルは ./make_deckey_id_def.sh により ./DecoderKeys.cs から自動的に作成されました (2021/09/23 11:59:58)
#pragma once
...
#define TOGGLE_UPPER_ROMAN_STROKE_GUID (BUSHU_COMP_HELP + 1)
#define TOGGLE_ROMAN_STROKE_GUID (TOGGLE_UPPER_ROMAN_STROKE_GUID + 1)
