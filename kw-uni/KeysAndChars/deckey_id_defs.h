...
// このファイルは tools/make_deckey_id_def.sh により KanchokuWS/DecoderKeys.cs から自動的に作成されました (2022/02/19 11:06:00)
#pragma once
...
#define TOGGLE_UPPER_ROMAN_STROKE_GUIDE_DECKEY (TOGGLE_ZENKAKU_CONVERSION_DECKEY + 1)
