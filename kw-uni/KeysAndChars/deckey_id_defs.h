...
// このファイルは tools/make_deckey_id_def.sh により KanchokuWS/DecoderKeys.cs から自動的に作成されました (2022/05/10 14:14:56)
#pragma once
...
#define SHIFT_DECKEY_END (SHIFT_DECKEY_START + NORMAL_DECKEY_NUM)

//// SHIFT_A修飾DECKEYの始まり
//#define SHIFT_A_DECKEY_START (SHIFT_DECKEY_END)

//// SHIFT_A修飾DECKEYの終わり(の次)
//#define SHIFT_A_DECKEY_END (SHIFT_A_DECKEY_START + NORMAL_DECKEY_NUM)

//// SHIFT_B修飾DECKEYの始まり
//#define SHIFT_B_DECKEY_START (SHIFT_A_DECKEY_END)

//// SHIFT_B修飾DECKEYの終わり(の次)
//#define SHIFT_B_DECKEY_END (SHIFT_B_DECKEY_START + NORMAL_DECKEY_NUM)

//// SHIFT_C修飾DECKEYの始まり
//#define SHIFT_C_DECKEY_START (SHIFT_B_DECKEY_END)

//// SHIFT_D修飾DECKEYの終わり(の次)
//#define SHIFT_C_DECKEY_END (SHIFT_C_DECKEY_START + NORMAL_DECKEY_NUM)

//// SHIFT_B修飾DECKEYの始まり
//#define SHIFT_D_DECKEY_START (SHIFT_C_DECKEY_END)

//// SHIFT_B修飾DECKEYの終わり(の次)
//#define SHIFT_D_DECKEY_END (SHIFT_D_DECKEY_START + NORMAL_DECKEY_NUM)

//// SHIFT_B修飾DECKEYの始まり
//#define SHIFT_E_DECKEY_START (SHIFT_D_DECKEY_END)

//// SHIFT_B修飾DECKEYの終わり(の次)
//#define SHIFT_E_DECKEY_END (SHIFT_E_DECKEY_START + NORMAL_DECKEY_NUM)

//// SHIFT_B修飾DECKEYの始まり
//#define SHIFT_F_DECKEY_START (SHIFT_E_DECKEY_END)

//// SHIFT_B修飾DECKEYの終わり(の次)
//#define SHIFT_F_DECKEY_END (SHIFT_F_DECKEY_START + NORMAL_DECKEY_NUM)

// 面の総数(通常面を含む)
#define ALL_PLANE_NUM (9)

// SHIFTキーの総数
#define TOTAL_SHIFT_DECKEY_NUM (NORMAL_DECKEY_NUM * (ALL_PLANE_NUM - 1))

// SHIFTキーの終わり(の次)
#define TOTAL_SHIFT_DECKEY_END (NORMAL_DECKEY_NUM + TOTAL_SHIFT_DECKEY_NUM)

/// <summary> 機能キー (Esc, 半/全, Tab, Caps, 英数, 無変換, 変換, かな, BS, Enter, Ins, Del, Home, End, PgUp, PgDn, ↑, ↓, ←, →)の始まり</summary>
#define FUNC_DECKEY_START (TOTAL_SHIFT_DECKEY_END)
...
// ストロークキーの終わり(の次)
#define STROKE_DECKEY_END (FUNC_DECKEY_END)

//// ストロークキーの数
//#define STROKE_DECKEY_NUM (STROKE_DECKEY_END)
...
// Ctrl修飾DECKEYの始まり
#define CTRL_DECKEY_START (COMBO_DECKEY_END)
...
/// </summary>
#define SPECIAL_DECKEY_ID_BASE (0x800)
...
#define CLEAR_STROKE_DECKEY (TOGGLE_BLOCKER_DECKEY + 1)
...
#define TOGGLE_UPPER_ROMAN_STROKE_GUIDE_DECKEY (TOGGLE_KATAKANA_CONVERSION_DECKEY + 1)
