...
// このファイルは ./make_deckey_id_def.sh により ./DecoderKeys.cs から自動的に作成されました (2022/01/14 11:58:45)
#pragma once
...
#define SEND_ESC_TO_DECODER_DECKEY (COPY_SELECTION_AND_SEND_TO_DICTIONARY_DECKEY + 1)
