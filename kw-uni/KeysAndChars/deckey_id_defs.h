...
#define FUNC_DECKEY_END (NORMAL_DECKEY_START + PLANE_DECKEY_NUM)

// 機能キーとして使われるDECKEYの数
#define FUNC_DECKEY_NUM (FUNC_DECKEY_END - NORMAL_DECKEY_NUM)

// SHIFT修飾DECKEYの始まり
#define SHIFT_DECKEY_START (PLANE_DECKEY_NUM)
