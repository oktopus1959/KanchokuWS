...
#define ORDERED_COMBO_DECKEY_START (COMBO_DECKEY_START + PLANE_DECKEY_NUM)

// カバリング(StackLike)同時打鍵用修飾DECKEYの始まり (1000)
#define STACKLIKE_COMBO_DECKEY_START (ORDERED_COMBO_DECKEY_START + PLANE_DECKEY_NUM)

// 同時打鍵用修飾DECKEYの終わり(の次) (1100)
#define COMBO_DECKEY_END (STACKLIKE_COMBO_DECKEY_START + PLANE_DECKEY_NUM)
...
#define EISU_COMBO_DECKEY_END (EISU_COMBO_DECKEY_START + PLANE_DECKEY_NUM)
...
// DECKEYの総数 (1400)
#define TOTAL_DECKEY_NUM (CTRL_SHIFT_FUNC_DECKEY_END)
...
#define HISTORY_FULL_CAND_DECKEY (COMMIT_STATE_DECKEY + 1)
#define HISTORY_FEW_CHARS_CAND_DECKEY (HISTORY_FULL_CAND_DECKEY + 1)
#define HISTORY_ONE_CHAR_CAND_DECKEY (HISTORY_FEW_CHARS_CAND_DECKEY + 1)
#define HISTORY_NEXT_SEARCH_DECKEY (HISTORY_ONE_CHAR_CAND_DECKEY + 1)
...
#define BUSHU_COMP_DECKEY (BUSHU_COMP_HELP_DECKEY + 1)

#define TOGGLE_ZENKAKU_CONVERSION_DECKEY (BUSHU_COMP_DECKEY + 1)
...
#define MAZE_CONVERSION_DECKEY (RIGHT_SHIFT_BLOCKER_DECKEY + 1)
#define LEFT_SHIFT_MAZE_START_POS_DECKEY (MAZE_CONVERSION_DECKEY + 1)
...
#define MODE_TOGGLE_FOLLOW_CARET_DECKEY2 (MODE_TOGGLE_FOLLOW_CARET_DECKEY + 1)

#define COPY_SELECTION_AND_SEND_TO_DICTIONARY_DECKEY (MODE_TOGGLE_FOLLOW_CARET_DECKEY2 + 1)
...
#define EISU_CONVERSION_DECKEY (EISU_MODE_CANCEL_DECKEY + 1)
#define EISU_DECAPITALIZE_DECKEY (EISU_CONVERSION_DECKEY + 1)

#define MULTI_STREAM_MODE_TOGGLE_DECKEY (EISU_DECAPITALIZE_DECKEY + 1)
#define MULTI_STREAM_NEXT_CAND_DECKEY (MULTI_STREAM_MODE_TOGGLE_DECKEY + 1)
#define MULTI_STREAM_PREV_CAND_DECKEY (MULTI_STREAM_NEXT_CAND_DECKEY + 1)
#define MULTI_STREAM_SELECT_FIRST_DECKEY (MULTI_STREAM_PREV_CAND_DECKEY + 1)
#define MULTI_STREAM_COMMIT_DECKEY (MULTI_STREAM_SELECT_FIRST_DECKEY + 1)

#define KANJI_PREFERRED_NEXT_DECKEY (MULTI_STREAM_COMMIT_DECKEY + 1)
#define STROKE_BACK_DECKEY (KANJI_PREFERRED_NEXT_DECKEY + 1)
#define FLUSH_OUTPUT_STRING_DECKEY (STROKE_BACK_DECKEY + 1)

#define UNDEFINED_DECKEY (FLUSH_OUTPUT_STRING_DECKEY + 1)
