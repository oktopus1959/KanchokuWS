...
// このファイルは ./make_deckey_id_def.sh により ./DecoderKeys.cs から自動的に作成されました (2021/12/18 15:33:55)
#pragma once
...
/// </summary>
#define SPECIAL_DECKEY_ID_BASE (0x200)
...
#define COPY_SELECTION_AND_SEND_TO_DICTIONARY (MODE_TOGGLE_FOLLOW_CARET_DECKEY + 1)
