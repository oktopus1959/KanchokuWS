...
namespace KanchokuWS
{
    ...
    public static class SpecialKeysAndFunctions
    {
        ...
        private static KeyOrFunction[] specialKeysAndFunctions = new KeyOrFunction[] {
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.LEFT_SHIFT_DECKEY, KeyModifiers.MOD_LSHIFT, "Lshift", "左シフト", "左シフト キー"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.LEFT_CONTROL_DECKEY, KeyModifiers.MOD_LCTRL, "Lctrl", "左コントロール", "左コントロール キー"),
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE, DecoderKeys.RIGHT_CONTROL_DECKEY, KeyModifiers.MOD_RCTRL, "Rctrl", "右コントロール", "右コントロール キー"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.EXCHANGE_CODE_TABLE_DECKEY, 0, "ExchangeCodeTable", "", "主・副テーブルファイルを入れ替える (トグル)"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_SELECT_FIRST_DECKEY, 0, "MultiStreamSelectFirst", "", "漢直・かな配列の融合時に先頭候補を選択"),
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.MULTI_STREAM_COMMIT_DECKEY, 0, "MultiStreamCommit", "", "漢直・かな配列の融合時に先頭候補だけを残して初期化する"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.SKIP_NEXT_STROKE_DECKEY, 0, "SkipNextStroke", "", "次打鍵をスキップする。次の打鍵を単打ではなく、複数ストロークの第1打鍵として扱いたいというケース"),
