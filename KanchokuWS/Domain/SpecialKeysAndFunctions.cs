...
namespace KanchokuWS
{
    ...
    public static class SpecialKeysAndFunctions
    {
        ...
        private static KeyOrFunction[] specialKeysAndFunctions = new KeyOrFunction[] {
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.EXCHANGE_CODE_TABLE2_DECKEY, 0, "ExchangeCodeTable2", "", "主・副テーブルファイルを切り替える; テーブル3が選択されていたら2に切り替える"),
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_FUNCTION, DecoderKeys.SELECT_CODE_TABLE3_DECKEY, 0, "SelectCodeTable3", "", "第3テーブルファイルに切り替える"),
