...
namespace KanchokuWS
{
    ...
    public static class SpecialKeysAndFunctions
    {
        ...
        private static KeyOrFunction[] specialKeysAndFunctions = new KeyOrFunction[] {
            ...
            new KeyOrFunction(KeyOrFunction.ATTR_EXTSINGLE | KeyOrFunction.ATTR_ASSIGNABLE, DecoderKeys.ALNUM_DECKEY, KeyModifiers.MOD_ALNUM, "alnum", "英数", "英数 キー", "alphanum", "eisu"),
