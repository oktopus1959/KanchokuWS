...
{
    /// <summary>
    /// キーの同時打鍵定義を表す、値オブジェクトクラス
    /// </summary>
    public class KeyCombination
    {
        /// <summary>
        /// 同時打鍵キーの組合せリスト。<br/>一意性を担保するためにキーを表すIDが小さい順に並んでいる
        /// </summary>
        public List<int> OrderedKeyList { get; private set; }
        ...
        /// </summary>
        public List<int> DecoderKeyList { get; private set; }
    }
}
