...
namespace KanchokuWS
{
    public static class Settings
    {
        ...
        public static bool ReadIniFile()
        {
            ...
            //-------------------------------------------------------------------------------------
            // 同時打鍵
            OverlappingKeyTimeRate = GetString("overlappingKeyTimeRate")._parseInt(0, 0);        // 重複時間率
            OverlappingKeyTimeMs = GetString("overlappingKeyTimeMs")._parseInt(0, 0);          // 重複時間率
            OverlappingMaxAllowedLeadTimeMs = GetString("overlappingMaxAllowedLeadTimeMs")._parseInt(0, 0);     // 許容リードタイム
