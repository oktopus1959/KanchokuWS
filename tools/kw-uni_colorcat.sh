...
|handleNextOrPrevCandTrigger|outputHistResult|StrokeMergerHistoryResidentStateImpl.HandleDeckeyChain|StartStateImpl.StartHandleDeckey.*==|^==*=$|\w+ candidate preferred' | \
