...
- [KanchokuWS で搭載された新機能](#KanchokuWS%20で搭載された新機能)
- [動作環境](#動作環境)
...
- [設定ファイル、その他各種ファイル](#設定ファイル、その他各種ファイル)
    - [kanchoku.ini の引き継ぎ](#kanchoku.ini%20の引き継ぎ)
...
- [その他の機能](#その他の機能)
    ...
    - [Ctrl-H や Ctrl-B,F,P,Nなどの特殊キーへの変換](#Ctrl-H%20や%20Ctrl-B,F,P,Nなどの特殊キーへの変換)
